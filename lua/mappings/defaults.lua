...
map("n", "<Tab>n", "<CMD>tab split<CR>", default_opts)
map("n", "<Tab>l", "<CMD>tabnext<CR>", default_opts)
map("n", "<Tab>h", "<CMD>tabprevious<CR>", default_opts)
map("n", "<Tab><Space>", "<CMD>tabclose<CR>", default_opts)
