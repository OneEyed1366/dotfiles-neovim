...
execute 'source ' . s:currDir . '/configs/insert.vim'
execute 'source ' . s:currDir . '/configs/scrolling.vim'
execute 'source ' . s:currDir . '/configs/jumplist.vim'
execute 'source ' . s:currDir . '/configs/code-actions.vim'
execute 'source ' . s:currDir . '/configs/file-commands.vim'
execute 'source ' . s:currDir . '/configs/tab-commands.vim'
execute 'source ' . s:currDir . '/configs/window-commands.vim'
execute 'source ' . s:currDir . '/configs/motion.vim'
execute 'source ' . s:currDir . '/configs/mappings.vim'
execute 'source ' . s:currDir . '/configs/settings.vim'
